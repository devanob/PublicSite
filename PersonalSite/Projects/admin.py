...
# import  wagtail.contrib.modeladmin.options as admin 
...
# #admin.modeladmin_register(CrontabSchedule)
# #admin.modeladmin_register(SolarSchedule)
# admin.modeladmin_register( ClockedScheduleAdmin)
# admin.modeladmin_register(PeriodicTaskAdmin)